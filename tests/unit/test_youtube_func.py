...
@pytest.mark.parametrize("URL, response", good_URL_data)# This decorator tells pytest to run the test function multiple times, each time with different parameters specified in the good_URL_data list
